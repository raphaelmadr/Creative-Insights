          ...
          <div style={{ display: "flex", flexWrap: "nowrap", alignItems: "center", gap: "0.5rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.55rem", flexShrink: 0 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.05rem" }}>
                <h3 style={{ margin: 0, fontSize: "var(--text-cardtitle)", fontWeight: 700, color: "var(--foreground)", whiteSpace: "nowrap" }}>{funnel.name}</h3>
                {/*
                ...
                */}
                <span style={{ fontSize: "var(--text-eyebrow)", color: "var(--muted)", fontWeight: 400, whiteSpace: "nowrap" }}>
            ...
            */}
            <div style={{ display: "flex", alignItems: "center", gap: "0.15rem", marginLeft: "auto", flexShrink: 0 }}>
              <button
                ...
                className="btn btn-icon" style={{ color: isWhyOpen(funnel) ? "var(--primary)" : undefined }}
              >
                <HelpCircle size={16} />
              </button>
          ...
          {isWhyOpen(funnel) && (() => {
            ...
            return (
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", background: "var(--background-main)", border: "1px solid var(--card-border)", borderRadius: "8px", padding: "0.85rem 0.95rem" }}>
                <span style={{ fontSize: "var(--text-control)", fontWeight: 700, color: "var(--foreground)" }}>
                  Por que os anúncios estão aqui?
                </span>

                <span style={{ fontSize: "var(--text-caption)", color: "var(--muted)", lineHeight: 1.55 }}>
                ...
                {channels.length === 0 ? (
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "0.15rem", paddingTop: "0.6rem", borderTop: "1px solid var(--card-border)" }}>
                    {channels.map(({ platform, count, criteria }) => {
                      ...
                      return (
                        <div key={platform.key} style={{ display: "flex", alignItems: "baseline", gap: "0.75rem", fontSize: "var(--text-caption)", lineHeight: 1.55 }}>
